...
@ProcessName("gift_average_percentile")
public class AveragePercentile extends org.fao.fenix.d3p.process.Process<PercentileParameters> {
    ...
    private String createQuery(Step source, PercentileParameters params, String tableName, Collection<Object> queryParams,Language[] languages) throws Exception {
        ...
        String query = population>0 && foodPopulation>=3 ?
                ...
                "( select * from raw_data offset 0 limit "+percentileSize+" ) perc_low\n" +
                "union all\n" +
